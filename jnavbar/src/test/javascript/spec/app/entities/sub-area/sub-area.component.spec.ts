...
import { SubAreaComponent } from 'app/entities/sub-area/sub-area.component';
import { SubAreaService } from 'app/entities/sub-area/sub-area.service';
import { SubArea } from 'app/shared/model/sub-area.model';

describe('Component Tests', () => {
    describe('SubArea Management Component', () => {
        let comp: SubAreaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SubAreaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.subAreas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
